  ...
  describe 'POST #create' do
    context 'with valid params' do
      it 'creates a new FavouriteHotel' do
        favourite_hotel = FavouriteHotel.create!(user_id: user.id, hotel_id: hotel.id)
        expect do
          post :create, params: { user_id: user.to_param, favourite_hotel: { user_id: user.to_param, hotel_id: hotel.to_param } }, session: valid_session
    ...
    context 'with invalid params' do
      it 'renders a JSON response with errors for the new hotel' do
        post :create, params: { user_id: user.to_param, favourite_hotel: { user_id: nil, hotel_id: nil } }, session: valid_session
